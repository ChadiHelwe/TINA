...
public class LoadDependencyTrees {
	...
	public static JSONArray parseRules(String ruleFile) throws org.json.simple.parser.ParseException, ParseException{
...
//		}
	...
	public static void checkMatch(String inputFile) throws IOException {
		...
		Iterator<edu.stanford.nlp.util.Pair<SemanticGraph, SemanticGraph>> sgIterator;
